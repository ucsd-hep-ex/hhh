...
def get_datasets(arrays):
    ...
    datasets["INPUTS/BoostedJets/pt"] = to_np_array(fj_pt, max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/eta"] = to_np_array(fj_eta, max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/phi"] = to_np_array(fj_phi, max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/sinphi"] = to_np_array(np.sin(fj_phi), max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/cosphi"] = to_np_array(np.cos(fj_phi), max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/mass"] = to_np_array(fj_mass, max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/sdmass"] = to_np_array(fj_sdmass, max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/nsub"] = to_np_array(fj_nsub, max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/tau21"] = to_np_array(fj_tau21, max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/tau32"] = to_np_array(fj_tau32, max_n=N_FJETS).astype("float32")
    datasets["INPUTS/BoostedJets/area"] = to_np_array(fj_area, max_n=N_FJETS).astype("float32")
