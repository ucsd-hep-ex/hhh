...
def main(test_file, pred_file, plot_dir, test_name, cut):
    ...
    ax.set(xlabel=r"reco H pT", ylabel=r"Matching efficiency", title=f"SPANet Boosted H Matching Efficiency vs. Reco H pT, AP cut at {cut}")
    plt.tight_layout()
    ...
    ax.set(xlabel=r"gen H pT", ylabel=r"Matching purity", title=f"SPANet Boosted H Matching purity vs. gen H pT, AP cut at {cut}")
    plt.tight_layout()
